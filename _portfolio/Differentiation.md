...
If such a linear operator \\(\delta_af \\) exists, we designate it as the \\(\hl{\text{Gateaux derivative of} f \text{at} a} \\). The proof of uniqueness of the Fréchet derivative of a function at a point can easily be extended to prove uniqueness of the Gateaux derivative of a function at a point.
